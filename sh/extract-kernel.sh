#!/bin/bash
#==================================================================================================
# Description: Extract the kernel from armbian
# Armbian source: https://github.com/ophub/amlogic-s9xxx-armbian
...
cp -f $(ls ${armbian_outputpath}/*.img 2>/dev/null | head -n 1) . && sync
...
tar -czf amlogic-s9xxx-kernel-${kernel_version}.tar.gz ${kernel_version} && sync
